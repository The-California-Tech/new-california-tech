 ...
 * this newsroom keeps a column called Notes, writes times in Pacific, or tags
...
/** The column editors already keep notes in. Must be rich_text. */
const NOTES_PROPERTY_NAME = 'Info';
