...
<main class="max-w-5xl mx-auto px-4 py-8" in:fade={{ duration: 300, delay: 300 }} out:fade={{ duration: 300 }}>
      ...
      {#each data.allTags as tag (tag.name)}
        <a
          ...
          <div class="flex justify-between items-start mb-2">
            ...
            <span
              class="text-sm px-2 py-1 bg-black/10 dark:bg-white/10 group-hover:bg-white/20 dark:group-hover:bg-black/20 rounded">
              {tag.count}
            </span>
          </div>
  ...
  <div class="mt-8 pt-4 border-t border-black/20 dark:border-white/20">
    <a href="/" class="inline-flex items-center gap-2 text-lg hover:underline">
